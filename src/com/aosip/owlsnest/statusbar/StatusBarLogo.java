...
public class StatusBarLogo extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    private static final String STATUS_BAR_AOSIP_LOGO_SHOW = "status_bar_aosip_logo_show";
    private static final String STATUS_BAR_AOSIP_LOGO_SHOW_ON_LOCK_SCREEN = "status_bar_aosip_logo_show_on_lock_screen";
    ...
    private static final String STATUS_BAR_AOSIP_LOGO_COLOR_DARK_MODE = "status_bar_aosip_logo_color_dark_mode";
    ...
    public void refreshSettings() {
        ...
        mShowLogo =
                (SwitchPreference) findPreference(STATUS_BAR_AOSIP_LOGO_SHOW);
        mShowLogo.setChecked(Settings.System.getInt(mResolver,
                "status_bar_aosip_logo_show", 1) == 1);
        mShowLogo.setOnPreferenceChangeListener(this);

        mShowLogoKeyguard =
                (SwitchPreference) findPreference(STATUS_BAR_AOSIP_LOGO_SHOW_ON_LOCK_SCREEN);
        mShowLogoKeyguard.setChecked(Settings.System.getInt(mResolver,
                "status_bar_aosip_logo_show_on_lock_screen", 0) == 1);
        mShowLogoKeyguard.setOnPreferenceChangeListener(this);

        mLogoStyle = (ListPreference) findPreference(KEY_AOSIP_LOGO_STYLE);
        int LogoStyle = Settings.System.getInt(mResolver,
                "status_bar_aosip_logo_style", 1);
        ...
        mHideLogo.setChecked(Settings.System.getInt(mResolver,
               "status_bar_aosip_logo_hide_logo", 1) == 1);
        ...
        int numberOfNotificationIcons = Settings.System.getInt(mResolver,
               "status_bar_aosip_logo_number_of_notification_icons", 4);
        ...
        // logo color
        mLogoColor =
            (ColorPickerPreference) findPreference(KEY_AOSIP_LOGO_COLOR);
        mLogoColor.setOnPreferenceChangeListener(this);
        intColor = Settings.System.getInt(mResolver,
                "status_bar_aosip_logo_color", 0xffffffff);
        ...
        mLogoColorDarkMode =
                (ColorPickerPreference) findPreference(STATUS_BAR_AOSIP_LOGO_COLOR_DARK_MODE);
        mLogoColorDarkMode.setOnPreferenceChangeListener(this);
        intColor = Settings.System.getInt(mResolver,
                "status_bar_aosip_logo_color_dark_mode", 0xff000000);
        hexColor = String.format("#%08x", (0xffffffff & intColor));
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mShowLogo) {
            ...
            Settings.System.putInt(mResolver,
                    "status_bar_aosip_logo_show",
                    value ? 1 : 0);
            return true;
        } else if (preference == mShowLogoKeyguard) {
            boolean value = (Boolean) newValue;
            Settings.System.putInt(mResolver,
                    "status_bar_aosip_logo_show_on_lock_screen",
                    value ? 1 : 0);
            return true;
            ...
            Settings.System.putInt(
                    mResolver, "status_bar_aosip_logo_style", LogoStyle);
            mLogoStyle.setSummary(mLogoStyle.getEntries()[index]);
            return true;
        } else if (preference == mHideLogo) {
            boolean value = (Boolean) newValue;
            Settings.System.putInt(mResolver,
                    "status_bar_aosip_logo_hide_logo",
                    value ? 1 : 0);
            return true;
            ...
            Settings.System.putInt(mResolver,
                    "status_bar_aosip_logo_number_of_notification_icons",
                    intValue);
            ...
            Settings.System.putInt(mResolver,
                    "status_bar_aosip_logo_color", intHex);
            return true;
            ...
            int intHex = ColorPickerPreference.convertToColorInt(hex);
            Settings.System.putInt(mResolver,
                    "status_bar_aosip_logo_color_dark_mode", intHex);
            return true;
        }
        return false;
    }
            ...
            switch (id) {
                case DLG_RESET:
                    ...
                    .setNeutralButton(R.string.reset_android_title,
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Settings.System.putInt(getOwner().mResolver,
                                    "status_bar_aosip_logo_show", 0);
                            Settings.System.putInt(getOwner().mResolver,
                                    "status_bar_aosip_logo_show_on_lock_screen", 1);
                            Settings.System.putInt(getOwner().mResolver,
                                    "status_bar_aosip_logo_style", 0);
                            Settings.System.putInt(getOwner().mResolver,
                                    "status_bar_aosip_logo_hide_logo", 0);
                            Settings.System.putInt(getOwner().mResolver,
                                    "status_bar_aosip_logo_number_of_notification_icons", 0);
                            Settings.System.putInt(getOwner().mResolver,
                                    "status_bar_aosip_logo_color",
                                    DEFAULT_COLOR);
                            Settings.System.putInt(getOwner().mResolver,
                                    "status_bar_aosip_logo_color_dark_mode",
                                    0xff000000);
                    ...
                    .setPositiveButton(R.string.reset_aosip_title,
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Settings.System.putInt(getOwner().mResolver,
                                    "status_bar_aosip_logo_show", 1);
                            Settings.System.putInt(getOwner().mResolver,
                                    "status_bar_aosip_logo_show_on_lock_screen", 1);
                            Settings.System.putInt(getOwner().mResolver,
                                    "status_bar_aosip_logo_style", 0);
                            Settings.System.putInt(getOwner().mResolver,
                                    "status_bar_aosip_logo_hide_logo", 1);
                            Settings.System.putInt(getOwner().mResolver,
                                    "status_bar_aosip_logo_number_of_notification_icons", 4);
                            Settings.System.putInt(getOwner().mResolver,
                                    "status_bar_aosip_logo_color",
